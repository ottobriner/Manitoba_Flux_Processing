...
input<-read.csv(paste('./processed/ATMOS_L1_2023-04-01.csv',sep=''))
...
met <- data.frame()
# fp <- paste("/home/otto/data/atmos-flux-data/output/atmos484_20230401_fluxnet.csv")
...
met$Hour <- as.numeric(met$hour) + (as.numeric(met$min) / 60)
met$Year <- as.integer(met$Year + 2000)
...
## dates are still off - midnight is still the previous day - maybe the pmatch will still work
# for(i in 1:length(met$date)){
#   if (met$date[i]=='2022-01-31' && met$time[i]=='0000'){
#     met$date[i]='2022-02-01'
#   }
#   if (met$date[i]=='2022-02-28' && met$time[i]=='0000'){
#     met$date[i]='2022-03-01'
#   }
#   if (met$date[i]=='2022-03-31' && met$time[i]=='0000'){
#     met$date[i]='2022-04-01'
#   }
#   if (met$date[i]=='2022-04-30' && met$time[i]=='0000'){
#     met$date[i]='2022-05-01'
#   }
#   if (met$date[i]=='2022-05-31' && met$time[i]=='0000'){
#     met$date[i]='2022-06-01'
#   }
#   if (met$date[i]=='2022-06-30' && met$time[i]=='0000'){
#     met$date[i]='2022-07-01'
#   }
#   if (met$date[i]=='2022-07-31' && met$time[i]=='0000'){
#     met$date[i]='2022-08-01'
#   }
#   if (met$date[i]=='2022-08-31' && met$time[i]=='0000'){
#     met$date[i]='2022-09-01'
#   }
#   if (met$date[i]=='2022-09-30' && met$time[i]=='0000'){
#     met$date[i]='2022-10-01'
#   }
#   if (met$date[i]=='2022-10-31' && met$time[i]=='0000'){
#     met$date[i]='2022-11-01'
#   }
#   if (met$date[i]=='2022-11-30' && met$time[i]=='0000'){
#     met$date[i]='2022-12-01'
#   }
#   if (met$date[i]=='2022-12-31' && met$time[i]=='0000'){
#     met$date[i]='2023-01-01'
#   }
# 
# }
