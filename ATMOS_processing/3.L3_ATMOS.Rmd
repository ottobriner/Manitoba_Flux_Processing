...
EddyData.F <- fLoadTXTIntoDataframe(paste0("/home/otto/data/atmos-flux-data/processed/REddyProc_input/for_gap_filling_partitioning_ATMOS_2023-03-31.txt"))
```
...
L2 <- read.csv(paste0("/home/otto/data/atmos-flux-data/processed/ATMOS_L2_2023-03-31", file_suffix, ".csv"))

met <- read.csv(paste0('/home/otto/data/atmos-flux-data/processed/Gapfilled_biomet_2023-03-31', file_suffix, '.csv'))
...
```{r format for FLUXNET, echo=FALSE, include=FALSE}

L3 <- read.csv(paste0('/home/otto/data/atmos-flux-data/processed/ATMOS_L3_', Sys.Date(), file_suffix, '.csv'))

write_csv(L3,paste0("/home/otto/data/atmos-flux-data/processed/ATMOS_L3_", Sys.Date(), file_suffix, "_full_output.csv"))

L3[is.na(L3)] = -9999

write_csv(L3, paste0("/home/otto/data/atmos-flux-data/processed/ATMOS_L3_", Sys.Date(), file_suffix, "_fluxnet.csv"))
