...
EddyData.F <- fLoadTXTIntoDataframe("/home/otto/data/atmos-flux-data/processed/REddyProc_input/for_gap_filling_partitioningATMOS.txt")
```
...
write_csv(FilledEddyData.F,"/home/otto/data/atmos-flux-data/processed/REddyProc_gapfilled_partition_fulloutputATMOS.csv")
```
...
Input <- read.table("/home/otto/data/atmos-flux-data/processed/REddyProc_input/for_gap_filling_partitioningATMOS.txt", header = T)
...
write_csv(rf_result_df,"/home/otto/data/atmos-flux-data/processed/ATMOS_rf_result.csv")

```

```{r Load L2 data, echo=FALSE, include=FALSE}

L2 <- read.csv(paste("/home/otto/data/atmos-flux-data/processed/ATMOS_L2",".csv",sep = ""),sep=",",header=TRUE,dec=".")

met <- read.csv('/home/otto/data/atmos-flux-data/processed/Gapfilled_biomet.csv')
...
write_csv(L3,"/home/otto/data/atmos-flux-data/processed/ATMOS_L3.csv")
