...
EddyData.F <- fLoadTXTIntoDataframe(paste0(dir, "/processed/REddyProc_input/for_gap_filling_partitioning_ATMOS_2023-04-11.txt"))
```
...
L2 <- read.csv(paste0("/home/otto/data/atmos-flux-data/processed/ATMOS_L2_2023-04-11", file_suffix, ".csv"))

met <- read.csv(paste0('/home/otto/data/atmos-flux-data/processed/Gapfilled_biomet_2023-04-11', file_suffix, '.csv'))
