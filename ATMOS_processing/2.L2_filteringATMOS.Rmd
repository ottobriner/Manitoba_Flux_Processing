...
knit: (function(inputFile, encoding) { 
      ...
      rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file=file.path('/home/otto/data/atmos-flux-data/output/', out_dir, 
...
ustar_max <- 1.2
wind_max <- 360 #degrees - added 14/12/20 - M.Nyberg
wind_min <- 0 #degrees - added 14/12/20 - M.Nyberg
...
# DON'T NEED THIS?? NOT USING NET RADIATION
...
# Load data
EddyData.F <- fLoadTXTIntoDataframe("/home/otto/data/atmos-flux-data/processed/REddyProc_input/for_ustar_filtering_2023-03-27.txt")
...
plot_ly(data = input, x = ~DATE, y = ~wind_dir, name = 'original', type = 'scatter', mode = 'line') %>%
  ...
  layout(title = 'wind direction') %>%  
  toWebGL()
```

### Variance Filtering
```{r Plot variances, echo=FALSE}
# Variances
