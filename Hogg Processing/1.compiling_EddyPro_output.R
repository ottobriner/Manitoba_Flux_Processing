...
#The output files to be compiled are"Hogg"
...
# set path
path <- "/Users/darianng/Google\ Drive/My\ Drive/Micromet\ Lab/Projects/2021-Hogg/Flux-tower/EP_outputs"
...
date_loca <- ymd_hms(cont.DS$DATE, tz="America/Winnepeg")
date_local<-as.POSIXlt(date_loca,tz="America/Winnepeg")
...
write.csv(cont.DS,paste('/Users/darianng/Google\ Drive/My\ Drive/Micromet\ Lab/Projects/2021-Hogg/Flux-tower/flux_data/Hogg_L1','.csv',sep =''),row.names=FALSE)
